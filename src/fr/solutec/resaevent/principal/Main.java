...
public static void main(String[] args) throws IOException {
    ...
    List<Adresse> adresseList = adresseService.read();
    ...
    if (numAsInteger == 1) {
        ...
        for (Adresse adresseId : adresseList) {
            ...
            //BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
            System.out.println("Veuillez-saisir l'id du l'utilisateur ");
    ...
    */
        ...
        for (int i = 1; i < 2; i++) {
            ...
            lieuService.update(lieuId, lieu.getIdAdresse());
            System.out.println(lieuId+ " " + lieu.getIdAdresse());
        }
        ...
        for (Lieu lieuId : lieuList) {
            ...
            System.out.println(" Lieu = " + lieuId.getNom()
                    +" ID Adresse = " + idAdresseAsInteger + " Adresse = "
                    + lieuId.getAdresse().getNumero()+ " " + lieuId.getAdresse().getRue()+ " "
                    + lieuId.getAdresse().getCodePostal()+" "+ lieuId.getAdresse().getVille()+" "+ lieuId.getAdresse().getRegion());
            }
        }
    }
}
